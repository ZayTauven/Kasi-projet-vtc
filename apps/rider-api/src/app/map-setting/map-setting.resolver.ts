...
// AVANT login (`home:` = LocationSelectionParentView dans rider main.dart), donc
// le choix de fournisseur fait au panel doit pouvoir être lu sans JWT — sinon il
// ne s'applique jamais au premier écran et un `mapProvider` périmé en cache local
