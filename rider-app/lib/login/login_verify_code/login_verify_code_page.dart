...
import 'package:kasi_rider/login/bloc/login_bloc.dart';
import 'package:kasi_rider/login/bloc/login_event.dart';
import 'package:kasi_rider/login/login.graphql.dart';
import 'package:kasi_rider/login/login_verify_code/bloc/last_send_code_at_cubit.dart';
import 'package:kasi_rider/login/login_verify_code/bloc/login_verify_code_bloc.dart';
import 'package:kasi_rider/login/login_verify_code/bloc/login_verify_code_event.dart';
                ...
                listener: (context, state) {
                  ...
                  if (state is LoginVerifyCodeErrorState) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: KasiBanner(state.errorMessage,
