...
import 'package:kasi_rider/login/bloc/login_loading_cubit.dart';
import 'package:kasi_rider/login/phone_auth_repository.dart';
import 'package:kasi_rider/login/login_name_form/login_name_form_page.dart';
import 'package:kasi_rider/login/login_phone_number/bloc/login_phone_number_bloc.dart';
import 'package:kasi_rider/login/login_phone_number/login_number_page.dart';
import 'package:kasi_rider/login/login_success/login_success_page.dart';
import 'package:kasi_rider/login/login_verify_code/bloc/login_verify_code_bloc.dart';
import 'package:kasi_rider/login/login_verify_code/login_verify_code_page.dart';
      ...
      providers: [
        ...
        BlocProvider(
            create: (context) => LoginPhoneNumberBloc(
                authRepository: context.read<PhoneAuthRepository>())),
      ],
      child: Scaffold(
