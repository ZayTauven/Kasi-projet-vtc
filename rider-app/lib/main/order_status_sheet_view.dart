...
import 'package:kasi_rider/chat/chat.graphql.dart';
...
import 'package:kasi_rider/main/enter_gift_code_sheet_view.dart';
import 'package:kasi_rider/main/order.graphql.dart';
import 'package:kasi_rider/main/pay_for_ride_sheet_view.dart';
import 'package:kasi_rider/main/ride_options_sheet_view.dart';
import 'package:kasi_rider/main/ride_safety_sheet_view.dart';
import 'package:kasi_rider/main/wait_time_sheet_view.dart';
    ...
    return BlocBuilder<MainBloc, MainBlocState>(
      builder: (context, state) {
        ...
        return Subscription$DriverLocationUpdated$Widget(
            ...
            builder: (result) {
              return KasiSheetView(child: BlocBuilder<MainBloc, MainBlocState>(
                builder: (context, state) {
                  state as OrderInProgress;
                  return Column(
                    children: [
  ...
  _launchUrl(BuildContext context, String url) async {
    ...
    if (!canLaunch) {
      const snackBar = SnackBar(
          content:
              KasiBanner("Command is not supported", type: BannerType.error));
