...
import { IRiderNotificationService } from '../interfaces/rider-notification.interface';

@Injectable()
export class FirebaseRiderNotificationService implements IRiderNotificationService {
  constructor() {}
