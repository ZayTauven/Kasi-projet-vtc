...
export class RequestEntity {
  ...
  @Column({ type: 'geometry', spatialFeatureType: 'MultiPoint', srid: 4326, transformer: new MultipointTransformer() })
  points!: Point[];

  @Column({ type: 'geometry', spatialFeatureType: 'MultiPoint', srid: 4326, transformer: new MultipointTransformer(), nullable: true })
  directions?: Point[];
